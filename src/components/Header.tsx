        ...
        <AnimatePresence>
          {isMenuOpen && (
            ...
            >
              ...
              {/* Social Icons - Mobile */}
              <motion.div 
                className="flex items-center justify-center gap-3 py-4 border-t border-border/30 mt-2"
                initial={{ opacity: 0, y: 10 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: 0.5 }}
              >
                ...
                <a 
                  href="#" 
                  className="w-9 h-9 rounded-full border border-primary flex items-center justify-center text-primary hover:bg-primary hover:text-primary-foreground transition-all"
                >
